        ...
        <main>
            <section style="background-color: #eeeeee;">
                <div class="container p-5" style="background-color: white; max-width: 700px;">
                    ...
                    <div class="row mt-5">
                        <form action="#" @submit.prevent="submitRegister1" class="needs-validation" novalidate>
                            <div class="mb-4">
                                <label for="fullName" class="form-label">Full Name</label>
                                <input type="text" class="form-control p-3" id="fullName" placeholder="Enter full name" v-model.trim.lazy="inputName" required>
                                <div class="valid-feedback">Looks good!</div>
                                <div class="invalid-feedback">Please enter name!</div>
                            </div>
                            <div class="mb-4">
                                <label for="emailAddress" class="form-label">Email Address</label>
                                <input type="email" class="form-control p-3" id="emailAddress" placeholder="Enter email address" v-model.trim.lazy="inputEmail" required>
                                <div class="valid-feedback">Looks good!</div>
                                <div class="invalid-feedback">Please enter email address!</div>
                            </div>
                            <div class="mb-5">
                                <label for="phoneNumber" class="form-label">Phone Number</label>
                                <input type="number" class="form-control p-3" id="phoneNumber" placeholder="Enter your Phone number" v-model.trim.lazy="inputPhone" required>
                                <div class="valid-feedback">Looks good!</div>
                            ...
                            <div class="row mt-5">
                                ...
                                <div class="col text-end">
                                    <button class="btn btn-primary py-sm-2 px-sm-4 py-lg-3 px-lg-5" @click="bootstrapValidate" type="submit">Next</button>
                                </div>
                            </div>
                        </form>
                    </div>
...
export default {
    ...
    setup(){
        ...
        bootstrapValidate()
        async function submitRegister1(){
            if(inputName.value && inputPhone.value && inputEmail.value){
                await allUsersApi.addNewUser1([inputName.value , inputPhone.value , inputEmail.value])
                router.push("/register2")
            }
        }
        return{ router , users , inputName , inputPhone , inputEmail , bootstrapValidate , submitRegister1 }
    }
}
</script>
