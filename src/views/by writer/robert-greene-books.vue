    ...
    <div class="container-fluid p-0">
        ...
        <main style="background-color: #eeeeee;">
            ...
            <section>
                <div class="container">
                    <div class="row mt-5">
                        <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3 justify-content-center my-1 mb-5" v-for="book in robertGreeneBooks" :key="book.name">
...
export default {
    ...
    setup(){
        const robertGreeneBooks = computed( () => books.robertGreeneBooks )
        const showSearch =true
        return{ robertGreeneBooks , showSearch }
    }
}
</script>
