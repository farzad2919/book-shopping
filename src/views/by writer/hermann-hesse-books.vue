    ...
    <div class="container-fluid p-0">
        ...
        <main style="background-color: #eeeeee;">
            ...
            <section>
                <div class="container">
                    <div class="row position-relative">
                        <img src="@/assets/img/slider/Slider-hermann hesse 2.jpg" alt="Hermann Hesse" class="img-fluid w-100 mb-3" width="100">
                        <!-- <p class="image-text">History Books</p> -->
                        <h3 class="mt-5">Hermann Hesse:</h3>
                        <p class="fs-5" align="justify"> Hermann Karl Hesse was a German-Swiss poet, novelist, and painter. His best-known works include Demian, Steppenwolf, Siddhartha, 
                            and The Glass Bead Game, each of which explores an individual's search for authenticity, self-knowledge and spirituality. In 1946, he received the Nobel Prize in Literature.
                        </p>
                    </div>
                </div>
            </section>
            ...
            <section>
                <div class="container">
                    <div class="row mt-5">
                        <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3 justify-content-center my-1 mb-5" v-for="book in hermannHesseBooks" :key="book.name">
...
export default {
    ...
    setup(){
        const hermannHesseBooks = computed( () => books.hermannHesseBooks )
        const showSearch = true
        return{ hermannHesseBooks , showSearch }
    }
}
</script>
